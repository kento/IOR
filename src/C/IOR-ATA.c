...
DelaySecs(int caltime)
{
    ...
    int v = 2 * 2 * 2 * 2 * 2;
    v = v * v;
    long buf_size = caltime;
    long unt = v * v * v ;
    int chunk = unt / numTasksWorld;
    int count = 0;
    unt = chunk * numTasksWorld;
    ...
    //      count--;
    //    }
    printf("%d: ATA: Did work(size: %d , unt: %d , count: %d ): %f [s] / %d [MB]\n", rank, (unt/ v / v) * count, (unt / v/ v), count, t2 - t1, caltime);
